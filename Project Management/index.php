...
<div id="socialBtnContainer mt-5">
    

    <main role="main" class="container mt-5">

      <div class="starter-template">
      <h2> Don't Forget to Follow Us on Social Media Platforms </h2>
        <a href="https://www.facebook.com/tanmay.chachad"><i
            class="fa-brands fa-square-facebook fa-3x"></i></a>
        <a href="https://www.instagram.com/tanmay0403/"><i class="fa-brands fa-instagram fa-3x"></i></a>
        <a href="https://www.linkedin.com/in/tanmay-chachad-04429b1b0/"><i class="fa-brands fa-linkedin fa-3x"></i></a>
      </div>
